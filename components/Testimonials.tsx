      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white/80 backdrop-blur-sm rounded-lg p-6 sm:p-8 shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1 border-l-4 border-gray-300"
            >
              ...
              <div className="border-t border-gray-200 pt-3 sm:pt-4">
                <p className="font-bold text-black text-sm sm:text-base">{testimonial.author}</p>
